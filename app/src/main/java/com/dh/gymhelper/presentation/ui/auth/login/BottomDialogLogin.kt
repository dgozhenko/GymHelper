...
class BottomDialogLogin : BottomSheetDialogFragment() {
    ...
    private fun emptyEmailAndPassword() {
        ...
        Snackbar.make(
            ...
            "Enter E-mail and Password please",
            Snackbar.LENGTH_SHORT
        ).show()
    }

    private fun emptyPassword() {
        Snackbar.make(dialog!!.window!!.decorView, "Enter Password please", Snackbar.LENGTH_SHORT)
            .show()
    }

    private fun emptyEmail() {
        binding.emailTextField.error = "Enter E-mail"
        Snackbar.make(dialog!!.window!!.decorView, "Enter E-mail please", Snackbar.LENGTH_SHORT)
            .show()
    }
}